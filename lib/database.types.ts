  ...
  public: {
    Tables: {
      ...
      devices: {
        Row: {
          ...
          verification_status: Database["public"]["Enums"]["device_verification"]
    ...
    Functions: {
      ...
      send_listing_message: {
        Args: { p_body: string; p_buyer_id?: string; p_listing_id: string }
        Returns: string
      }
      set_my_location: {
    ...
    Enums: {
      device_verification: "pendente" | "aprovado" | "recusado"
      dispute_status:
        | "aberta"
        | "em_analise"
        | "resolvida"
